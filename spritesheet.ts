...
export function getDecorationValue(decoration: DecorationFrame): number {
  if (decoration >= DecorationFrame.OnePink && decoration <= DecorationFrame.TenPink) {
    return parseInt(decoration) - parseInt(DecorationFrame.OnePink) + 1;
  }
  else if (decoration >= DecorationFrame.OneBrown && decoration <= DecorationFrame.TenBrown) {
    return parseInt(decoration) - parseInt(DecorationFrame.OneBrown) + 1;
  }
...
export function drawItem(tile: TileFrame, x: number, y: number, decoration?: DecorationFrame, width?: number, height?: number) {
  ...
  if (decoration) {
    let dy = 0;
    if (
      (decoration >= DecorationFrame.OnePink && decoration <= DecorationFrame.TenPink) ||
      (decoration >= DecorationFrame.OneBrown && decoration <= DecorationFrame.TenBrown) ||
